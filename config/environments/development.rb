Rails.application.configure do
  ...
  config.idp_cert = File.read('/etc/pki/tls/certs/Shibb_4443_Cert.crt')
  config.certificate = File.read('/etc/pki/tls/certs/oig-dev-SP.crt')
  config.private_key = File.read('/etc/pki/tls/private/oig-dev-SP.key')
