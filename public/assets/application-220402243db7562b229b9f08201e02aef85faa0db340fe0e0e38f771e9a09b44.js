...
(function() {
  $(document).on('turbolinks:load', function() {
    $('#runBrokenLinkReport').click(function() {
...
(function() {
  ...
  $(document).on('turbolinks:load', function() {
    ...
    $('li.parent ul li.is-active').each(function() {
      return $(this).closest('li.parent').addClass('is-active-parent');
    });
  });

  $(document).on('click', '.add-label-modal', function() {
    $("#label_name").val('');
  ...
  $(document).on('turbolinks:load', function() {
    ...
    return $('#page_alwaysShow').change(function() {
      var selectedValue;
...
(function() {
  ...
  $(document).on('click', '.add_fields', function(event) {
    ...
    $('.collection-check-box input[type=checkbox]').change(function() {
      if ($(this).prop('checked')) {
        return $(this).closest('.collection-check-box').toggleClass('selected');
      } else {
        return $(this).closest('.collection-check-box').toggleClass('selected');
      }
    });
...
(function() {
  $(document).on('click', '.field > .radio > .checkbox > :checkbox', function(event) {
    $(event.target).parent().parent().find('.checkbox > :checkbox').each(function(i, element) {
